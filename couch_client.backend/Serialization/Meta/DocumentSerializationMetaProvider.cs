...
#else
            return docType.GetTypeInfo().GetCustomAttribute<DocumentAttribute>(true);
#endif
        }
...
#else
            return docType.GetTypeInfo().IsClass &&
                docType.GetTypeInfo().IsNotPublic &&
                docType.GetTypeInfo().IsSealed &&
                docType.GetTypeInfo().IsGenericType &&
                docType.GetTypeInfo().BaseType == typeof(object) &&
